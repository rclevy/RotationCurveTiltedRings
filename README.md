...
This python version is published to accompany the paper by [Cooke, Levy et al. (2022)](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.1012C/abstract)
...
<img src="https://render.githubusercontent.com/render/math?math=V(r) = V_{\rm{rot}}(r)\cos(\phi)\sin(i) %2B V_{\rm{rad}}(r)\sin(\phi)\sin(i) %2B \Delta V_{\rm{sys}}(r)">
...
<img src="https://user-images.githubusercontent.com/14076216/114915697-e33c6f80-9df1-11eb-9958-4c7d867dac6d.png" width="500">

- The residuals are small (note the colorbar scale). There are some patterns in the residuals at the center, likely due to the bar in this galaxy. These correspond to the non-zero radial and systemic components in the rotation curve shown above.
...
The ALMA data used for this study are part of program ADS/JAO.ALMA#2015.1.00820.S (PI L. Blitz) and are publicly available on the [ALMA Science Archive](https://almascience.nrao.edu/asax/). Data products published in [Cooke, Levy et al. (2022)](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.1012C/abstract) are available here (`CODataProducts_Cooke2021.tar.gz`). See Section 2 of [Cooke, Levy, et al. (2022)](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.1012C/abstract) for details on the data calibration and imaging. The products presented here are the results of Gaussian fits to the spectra in the data cube to extract the peak intensity, velocity centroid, and line width. These data products include:
